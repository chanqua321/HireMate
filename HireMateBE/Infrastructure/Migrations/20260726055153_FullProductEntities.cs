...
{
    /// <inheritdoc />
    public partial class FullProductEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FormatScore = table.Column<int>(type: "int", nullable: true),
                    KeywordsScore = table.Column<int>(type: "int", nullable: true),
                    ReadabilityScore = table.Column<int>(type: "int", nullable: true),
                    ProfessionalismScore = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JdMatchResults", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JdMatchResults_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Invoices_SubscriptionPlans_PlanId",
                        column: x => x.PlanId,
